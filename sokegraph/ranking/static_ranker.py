...
class StaticRanker(BaseRankingMethod):
    ...
    def rank(self):
            ...
            for category, items in categories.items():
                for item in items:
                    ...
                    for kw in item["keywords"]:
                        ...
                        print(f"kw_lower : {kw_lower}, layer : {layer}, category : {category}, paper_id : {paper_id}")
        
        static_ranked, low_sorted, pair_file_path = self.find_common_papers(
            category_to_papers,
            paper_keyword_map,
            title_map,
            kw_lookup,
        ...
        return static_outputs_csv, static_outputs_all
    ...
    def find_common_papers(
        ...
        ranked_paper_ids = {pid for pid, _ in set(static_ranked)}
        ...
        if len(per_cat_hits) < 2:
            ...
            return static_ranked, low_sorted, df_pairs_file_path
